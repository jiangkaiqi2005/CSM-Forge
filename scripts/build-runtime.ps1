...
4. Host opens CSM-Forge multiplayer from the pause menu and chooses 复制邀请码并打开 Steam 好友, then pastes the copied direct-connect invitation to the friend. Automatic Steam click-to-join is disabled because a real CS1 run ended in a native access violation on the unverified bridge path. This is direct UDP discovery only and does not provide NAT traversal or relay.
